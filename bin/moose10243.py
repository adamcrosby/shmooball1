...
try:
    moosemode = int(r.get('3:honk_action'))
except:
    moosemode = None
...
if moosemode > 0:
    r.delete('3:honk_action')
    print 3
    sys.exit(254)

try:
    count = int(r.get('3:ballcount'))
except:
    count = 0
