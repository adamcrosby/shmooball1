...
try:
    moosemode = int(r.get('1:honk_action'))
except:
    moosemode = None
...
if moosemode > 0:
    r.delete('1:honk_action')
    print 3
    sys.exit(254)

try:
    count = int(r.get('1:ballcount'))
except:
    count = 0
